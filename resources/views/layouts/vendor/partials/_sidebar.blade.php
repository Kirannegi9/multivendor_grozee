                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/item*')?'active':''}}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: {{Request::is('store-panel/item*')?'block':'none'}}">
                            ...
                            <li class="nav-item {{Request::is('store-panel/unit*')?'active':''}}">
                                <a class="nav-link " href="{{route('vendor.unit.list')}}"
                                    title="{{translate('messages.units')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{translate('messages.units')}}</span>
                                </a>
                            </li>
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/unit*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('vendor.unit.list')}}" title="{{translate('messages.units')}}">
