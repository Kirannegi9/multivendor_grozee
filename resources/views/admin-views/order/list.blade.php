                        ...
                        <tr class="status-{{$order['order_status']}} class-all">
                                    ...
                                    @if(!empty($order->schedule_at) && strpos($order->schedule_at, ' to ') !== false)
                                        ...
                                        <div>
                                            @if(!empty($start))
                                                ...
                                                @if(!empty($end))
                                                    <span> - {{ \App\CentralLogics\Helpers::date_format($end) }}</span>
                                                @endif
                                            @else
                                                {{ $order->schedule_at }}
                                            @endif
                                        ...
                                        <div class="d-block text-uppercase">
                                            @if(!empty($start))
                                                {{ \App\CentralLogics\Helpers::time_format($start) }}
                                                @if(!empty($end))
                                                    <span> - {{ \App\CentralLogics\Helpers::time_format($end) }}</span>
                                                @endif
                                            @endif
                                        </div>
                                    @else
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    ...
                                    <a class="ml-2 btn btn-sm btn--primary btn-outline-primary action-btn" href="{{route($parcel_order?'admin.parcel.order.generate-invoice':'admin.order.generate-invoice',['id'=>$order['id']])}}">
                                        <i class="tio-print"></i>
                                    </a>
                                </div>
                            </td>
