                        ...
                        <tr class="status-{{$order['order_status']}} class-all">
                            ...
                            @if ($status == 'scheduled')
                                <td>
                                    <div>
                                        @php
                                            // Split the schedule_at into start and end times if it contains " to "
                                            $start_time = null;
                                            $end_time = null;
                                        ...
                                        <div>
                                            @if ($start_time)
                                                {{ Helpers::date_format($start_time) }}
                                                @if ($end_time)
                                                    <span> - {{ Helpers::date_format($end_time) }}</span>
                                                @endif
                                            @else
                                                {{ $order->schedule_at }}
                                            @endif
                                        ...
                                        <div class="d-block text-uppercase">
                                            @if ($start_time)
                                                {{ Helpers::time_format($start_time) }}
                                                @if ($end_time)
                                                    <span> - {{ Helpers::time_format($end_time) }}</span>
                                                @endif
                                            @endif
                                        </div>
                                    </div>
