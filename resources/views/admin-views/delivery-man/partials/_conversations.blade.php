<div class="card h-100">
    ...
    <div class="mt-auto d-flex justify-content-center fs-12 font-medium text-dark p-3">
        {{ translate('You_canâ€™t_reply_to_this_conversation.') }} &nbsp;
        <div class="text-danger d-inline-block learn-more-wrap cursor-pointer">
            ...
            <div class="learn-more-content p-4">
                ...
                <p class="mb-0 text-muted text-normal">{{ translate('You canâ€™t chat with deliveryman because itâ€™s delivery man previous chat history, only you can monitor or view their conversation to avoid unexpected situation.')}}</p>
            </div>
        </div>
    </div>
