                ...
                @csrf
                    ...
                    @endif
                       ...
                       <input name="position" value="1" type="hidden">
                        ...
                        <div class="col-sm-2">
                            <label class="input-label">{{ translate('messages.sub_category_image') }} <span class="text-danger">*</span></label>
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <label class="position-relative">
                                    <img class="img--176 border" id="viewer" src="{{ asset('assets/admin/img/upload-img.png') }}" alt="image">
                                    <div class="icon-file-group">
                                        <div class="icon-file">
                                            <input type="file" name="image" id="customFileEg1" class="custom-file-input read-url" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                            <i class="tio-edit"></i>
                                        </div>
                                    </div>
                                </label>
