                        ...
                        <div class="modal-body">
                            <div class="how-it-works">
                                <div class="item">
                                    ...
                                    <p>
                                        {{ translate('To_create_a_new_business_module,_go_to:_â€˜Module_Setupâ€™_â†’_â€˜Add_Business_Module.â€™')}}
                                    </p>
                                </div>
                                <div class="item">
                                    ...
                                    <p>
                                        {{ translate('Go_to_â€˜Zone_Setupâ€™â†’_â€˜Business_Zone_Listâ€™â†’_â€˜Zone_Settingsâ€™â†’_Choose_Payment_Methodâ†’Add_Business_Module_into_Zone_with_Parameters.') }}
                                    </p>
                                </div>
                                <div class="item mw-100">
                                    ...
                                    <p>
                                        {{ translate('Select_your_Module_from_the_Module_Section,_Click_â†’_â€™Store_Managementâ€™â†’â€™Add_Storeâ€™â†’Add_Store_details_&_select_Zone_to_integrate_Module+Zone+Store.') }}
                                    </p>
                                </div>
                            </div>
                        </div>
