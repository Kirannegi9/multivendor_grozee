    ...
    <div class="page-header">
        ...
        <div class="alert alert-soft-primary alert-dismissible fade show d-flex" role="alert">
            ...
            <div class="w-0 flex-grow-1 pl-3">
                <strong>{{ translate('Attention!') }}</strong> {{ translate('Donâ€™t_forget_to_click_the_â€˜Add_Moduleâ€™_button_below_to_save_the_new_business_module') }}
            </div>
            ...
            <div class="d-flex flex-wrap justify-content-end align-items-center flex-grow-1 p--10">
                <div class="blinkings active">
                    ...
                    <div class="business-notes">
                        ...
                        <div>
                        {{translate('messages.Donâ€™t_forget_to_click_the_â€˜Add_Moduleâ€™_button_below_to_save_the_new_business_module.')}}
                        </div>
                    </div>
                </div>
            </div>
