                        ...
                        <div class="col-md-5">
                            <div class="zone-setup-instructions">
                                ...
                                <div class="zone-setup-item">
                                    ...
                                    <div class="info">
                                        {{ translate('Use_this_â€˜Hand_Toolâ€™_to_find_your_target_zone.') }}
                                    </div>
                                </div>
                                <div class="zone-setup-item">
                                    <div class="zone-setup-icon">
                                    ...
                                    <div class="info">
                                        {{ translate('Use_this_â€˜Shape_Toolâ€™_to_point_out_the_areas_and_connect_the_dots._Minimum_3_points/dots_are_required.') }}
                                    </div>
                                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="digital_paymentCheckbox{{$zone->id}}">
                                            <input type="checkbox" data-id="digital_payment-{{$zone['id']}}" data-title="{{ $zone->digital_payment?translate('Want_to_disable_â€˜Digital_Paymentâ€™?'):translate('Want_to_enable_â€˜Digital_Paymentâ€™?') }}" data-message="{{ $zone->digital_payment? translate('If_yes,_the_digital_payment_option_will_be_hidden_during_checkout.'):translate('If_yes,_Customers_can_choose_the_â€˜Digital_Paymentâ€™_option_during_checkout.')}}" class="toggle-switch-input status_form_alert" id="digital_paymentCheckbox{{$zone->id}}" {{$zone->digital_payment?'checked':''}}>
                                            <span class="toggle-switch-label">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="cashOnDeliveryCheckbox{{$zone->id}}">
                                            <input type="checkbox" data-id="cash_on_delivery-{{$zone['id']}}" data-title="{{ $zone->cash_on_delivery?translate('Want_to_disable_â€˜Cash_On_Deliveryâ€™?'):translate('Want_to_enable_â€˜Cash_On_Deliveryâ€™?') }}" data-message="{{ $zone->cash_on_delivery? translate('If_yes,_the_Cash_on_Delivery_option_will_be_hidden_during_checkout.'):translate('If_yes,_Customers_can_choose_the_â€˜Cash_On_Deliveryâ€™_option_during_checkout.')}}" class="toggle-switch-input status_form_alert" id="cashOnDeliveryCheckbox{{$zone->id}}" {{$zone->cash_on_delivery?'checked':''}}>
                                            <span class="toggle-switch-label">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="offline_paymentCheckbox{{$zone->id}}">
                                            <input type="checkbox" data-id="offline_payment-{{$zone['id']}}" data-title="{{ $zone->offline_payment?translate('Want_to_disable_â€˜offline_Paymentâ€™?'):translate('Want_to_enable_â€˜offline_Paymentâ€™?') }}" data-message="{{ $zone->offline_payment? translate('If_yes,_the_offline_payment_option_will_be_hidden_during_checkout.'):translate('If_yes,_Customers_can_choose_the_â€˜offline_Paymentâ€™_option_during_checkout.')}}" class="toggle-switch-input status_form_alert" id="offline_paymentCheckbox{{$zone->id}}" {{$zone->offline_payment?'checked':''}}>
                                            <span class="toggle-switch-label">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                            ...
                                            <div class="popover-wrapper {{ $non_mod == 1 ? 'active':'' }}">
                                                ...
                                                <div class="popover __popover">
                                                    ...
                                                    <div class="popover-body">
                                                        {{ translate('The_Business_Zone_will_NOT_work_if_you_donâ€™t_select_your_business_module_&_payment_method.') }}
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="text-center mb-3">
                    ...
                    <p class="txt">
                        {{translate("NEXT_IMPORTANT_STEP:_You_need_to_select_â€˜Payment_Methodâ€™_and_add_â€˜Business_Modulesâ€™_with_other_details_from_the_Zone_Settings._If_you_donâ€™t_finish_the_setup,_the_Zone_you_created_wonâ€™t_function_properly.")}}
                    </p>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <div class="text-center mb-20">
                        ...
                        <h5 class="modal-title">{{translate('By switching the status to â€œONâ€,  this zone and under all the functionality of this zone will be turned on')}}</h5>
                        <p class="txt">
