                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{translate('Send_Mail_On_â€˜Forgot_Passwordâ€™?')}}
                                <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_a_user_clicks_â€˜Forgot_Passwordâ€™_during_login,_an_automated_email_will_be_sent_to_the_admin.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input dynamic-checkbox"
                                        ...
                                        data-text-on="<p>{{translate('If_enabled,_admin_will_receive_an_email_when_a_user_click_on_â€˜Forgot_Password.â€™')}}</p>"
                                        data-text-off="<p>{{translate('If_disabled,_admin_will_not_receive_an_email_when_a_user_click_on_â€˜Forgot_Password.â€™')}}</p>"
                                        ...
                                        <div class="__bg-F8F9FC-card">
                                                @if ($language)
                                                        <div class="form-group lang_form default-form">
                                                            ...
                                                            <input type="text" data-id="mail-footer" name="footer_text[]"  placeholder="{{ translate('Please_contact_us_for_any_queries;_weâ€™re_always_happy_to_help.') }}"class="form-control" value="{{ $data?->getRawOriginal('footer_text') }}">
                                                        </div>
                                                    @foreach(json_decode($language) as $lang)
                                                    <?php
                                                    if($data && count($data['translations'])){
                                                        ...
                                                        <div class="form-group d-none lang_form" id="{{$lang}}-form2">
                                                            ...
                                                            <input type="text" name="footer_text[]"  placeholder="{{ translate('Please_contact_us_for_any_queries;_weâ€™re_always_happy_to_help.') }}"class="form-control" value="{{ $translate[$lang]['footer_text']??'' }}">
                                                        </div>
                                                    @endforeach
                                                @else
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="{{ translate('Please_contact_us_for_any_queries;_weâ€™re_always_happy_to_help.') }}"class="form-control" name="footer_text[]" value="">
                                                </div>
                                                @endif
