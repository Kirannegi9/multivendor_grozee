                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{translate('Receive_Mail_On_â€˜New_Deliveryman_Registrationâ€™?')}}
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group m-0">
                                                        ...
                                                        <input type="text" name="button_url" placeholder="{{ translate('Please_contact_us_for_any_queries;_weâ€™re_always_happy_to_help.') }}"class="form-control" value="{{ $data['button_url']??'' }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
