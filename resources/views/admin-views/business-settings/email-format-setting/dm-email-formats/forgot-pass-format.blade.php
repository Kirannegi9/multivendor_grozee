            ...
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_a_Deliveryman_tap_on_â€˜Forgot_Passwordâ€™_during_login,_an_automated_email_will_be_sent_from_the_system_with_a_Reset_Password_Link.') }}">
