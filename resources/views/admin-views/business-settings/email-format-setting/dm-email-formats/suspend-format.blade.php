                    ...
                    <div class="card-body">
                        <div class="maintenance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{translate('Send_Mail_On_Deliverymanâ€™s_â€˜Account_Suspensionâ€™?')}}
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_Store/Admin_wants,_they_can_suspend_a_Deliverymanâ€™s_account._If_a_Store_or_Admin_suspends_a_Deliverymanâ€™s_account,_he_will_receive_an_automated_email.') }}">
