                            ...
                            <div class="max-349 mx-auto mb-20">
                                <div>
                                    ...
                                    <div class="text-center" >
                                        ...
                                        <div > <p> <strong>{{ translate('For_example,') }}</strong> {{ translate('if the â€˜Order Placedâ€˜ push notification is turned off for a customer, they will not receive a push notification in the customer app when an order is placed.') }}</h3></p></div>
                                    </div>
