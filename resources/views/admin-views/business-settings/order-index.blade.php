                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <label
                                                ...
                                                <input type="checkbox"
                                                       ...
                                                       data-text-off="<p>{{ translate('messages.If you disable this, the Deliveryman will deliver the order and update the status. He doesnâ€™t need to verify the order with any code.') }}</p>"
                                        ...
                                        <div class="form-group mb-0">
                                            <label
                                                ...
                                                <span class="pr-1 d-flex align-items-center switch--label">
                                                    ...
                                                    <span class="form-label-secondary text-danger d-flex"
                                                        data-toggle="tooltip" data-placement="right"
                                                        data-original-title="{{ translate('messages.If_you_enable_this_feature,_customers_can_choose_â€˜Home_Deliveryâ€™_and_get_the_product_delivered_to_their_preferred_location.') }}"><img
                                                            src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                        ...
                                        <div class="form-group mb-0">
                                            <label
                                                ...
                                                <span class="pr-1 d-flex align-items-center switch--label">
                                                    ...
                                                    <span class="form-label-secondary text-danger d-flex"
                                                        data-toggle="tooltip" data-placement="right"
                                                        data-original-title="{{ translate('messages.If_you_enable_this_feature,_customers_can_place_an_order_and_request_â€˜Takeawaysâ€™_or_â€˜self-pick-upâ€™_from_stores.') }}"><img
                                                            src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                            alt="{{ translate('Home Delivery') }}"></span>
                                                </span>
                                                <input type="checkbox"
            ...
            <div class="mt-4">
                ...
                <form action="{{ route('admin.business-settings.order-cancel-reasons.store') }}" method="post">
                    @csrf
                        ...
                        <div class="mt-2">
                            {{ translate('messages.*Users_cannot_cancel_an_order_if_the_Admin_does_not_specify_a_cause_for_cancellation,_even_though_they_see_the_â€˜Cancel_Orderâ€˜_option._So_Admin_MUST_provide_a_proper_Order_Cancellation_Reason_and_select_the_related_user.')}}
                       </div>
