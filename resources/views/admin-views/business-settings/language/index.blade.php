                                    ...
                                    <div class="form-group">
                                        <label for="country-code"
                                               ...
                                               <select id="country-code" name="code" class="form-control js-select2-custom">
                                                ...
                                                <option value="es-419">Spanish (Latin America) - espaÃ±ol (LatinoamÃ©rica)
                                                </option>
                                                <option value="es-MX">Spanish (Mexico) - espaÃ±ol (MÃ©xico)</option>
                                                <option value="es-ES">Spanish (Spain) - espaÃ±ol (EspaÃ±a)</option>
                                                <option value="es-US">Spanish (United States) - espaÃ±ol (Estados Unidos)
                                                </option>
...
{{--                                                    <option value="am" {{ $data['code']== 'am'?'selected':'' }}>Amharic - áŠ áˆ›áˆ­áŠ›</option>--}}
{{--                                                    <option value="ar" {{ $data['code']== 'ar'?'selected':'' }}>Arabic - Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©</option>--}}
{{--                                                    <option value="an" {{ $data['code']== 'an'?'selected':'' }}>Aragonese - aragonÃ©s</option>--}}
{{--                                                    <option value="hy" {{ $data['code']== 'hy'?'selected':'' }}>Armenian - Õ°Õ¡ÕµÕ¥Ö€Õ¥Õ¶</option>--}}
{{--                                                    <option value="ast" {{ $data['code']== 'ast'?'selected':'' }}>Asturian - asturianu</option>--}}
{{--                                                    <option value="az" {{ $data['code']== 'az'?'selected':'' }}>Azerbaijani - azÉ™rbaycan dili</option>--}}
{{--                                                    <option value="eu" {{ $data['code']== 'eu'?'selected':'' }}>Basque - euskara</option>--}}
{{--                                                    <option value="be" {{ $data['code']== 'be'?'selected':'' }}>Belarusian - Ð±ÐµÐ»Ð°Ñ€ÑƒÑÐºÐ°Ñ</option>--}}
{{--                                                    <option value="bn" {{ $data['code']== 'bn'?'selected':'' }}>Bengali - à¦¬à¦¾à¦‚à¦²à¦¾</option>--}}
...
{{--                                                    <option value="bg" {{ $data['code']== 'bg'?'selected':'' }}>Bulgarian - Ð±ÑŠÐ»Ð³Ð°Ñ€ÑÐºÐ¸</option>--}}
{{--                                                    <option value="ca" {{ $data['code']== 'ca'?'selected':'' }}>Catalan - catalÃ </option>--}}
{{--                                                    <option value="ckb" {{ $data['code']== 'ckb'?'selected':'' }}>Central Kurdish - Ú©ÙˆØ±Ø¯ÛŒ (Ø¯Û•Ø³ØªÙ†ÙˆØ³ÛŒ Ø¹Û•Ø±Û•Ø¨ÛŒ)</option>--}}
{{--                                                    <option value="zh" {{ $data['code']== 'zh'?'selected':'' }}>Chinese - ä¸­æ–‡</option>--}}
{{--                                                    <option value="zh-HK" {{ $data['code']== 'zh-HK'?'selected':'' }}>Chinese (Hong Kong) - ä¸­æ–‡ï¼ˆé¦™æ¸¯ï¼‰</option>--}}
{{--                                                    <option value="zh-CN" {{ $data['code']== 'zh-CN'?'selected':'' }}>Chinese (Simplified) - ä¸­æ–‡ï¼ˆç®€ä½“ï¼‰</option>--}}
{{--                                                    <option value="zh-TW" {{ $data['code']== 'zh-TW'?'selected':'' }}>Chinese (Traditional) - ä¸­æ–‡ï¼ˆç¹é«”ï¼‰</option>--}}
{{--                                                    <option value="co" {{ $data['code']== 'co'?'selected':'' }}>Corsican</option>--}}
{{--                                                    <option value="hr" {{ $data['code']== 'hr'?'selected':'' }}>Croatian - hrvatski</option>--}}
{{--                                                    <option value="cs" {{ $data['code']== 'cs'?'selected':'' }}>Czech - ÄeÅ¡tina</option>--}}
...
{{--                                                    <option value="fo" {{ $data['code']== 'fo'?'selected':'' }}>Faroese - fÃ¸royskt</option>--}}
{{--                                                    <option value="fil" {{ $data['code']== 'fil'?'selected':'' }}>Filipino</option>--}}
{{--                                                    <option value="fi" {{ $data['code']== 'fi'?'selected':'' }}>Finnish - suomi</option>--}}
{{--                                                    <option value="fr" {{ $data['code']== 'fr'?'selected':'' }}>French - franÃ§ais</option>--}}
{{--                                                    <option value="fr-CA" {{ $data['code']== 'fr-CA'?'selected':'' }}>French (Canada) - franÃ§ais (Canada)</option>--}}
{{--                                                    <option value="fr-FR" {{ $data['code']== 'fr-FR'?'selected':'' }}>French (France) - franÃ§ais (France)</option>--}}
{{--                                                    <option value="fr-CH" {{ $data['code']== 'fr-CH'?'selected':'' }}>French (Switzerland) - franÃ§ais (Suisse)</option>--}}
{{--                                                    <option value="gl" {{ $data['code']== 'gl'?'selected':'' }}>Galician - galego</option>--}}
{{--                                                    <option value="ka" {{ $data['code']== 'ka'?'selected':'' }}>Georgian - áƒ¥áƒáƒ áƒ—áƒ£áƒšáƒ˜</option>--}}
{{--                                                    <option value="de" {{ $data['code']== 'de'?'selected':'' }}>German - Deutsch</option>--}}
{{--                                                    <option value="de-AT" {{ $data['code']== 'de-AT'?'selected':'' }}>German (Austria) - Deutsch (Ã–sterreich)</option>--}}
...
{{--                                                    <option value="el" {{ $data['code']== 'el'?'selected':'' }}>Greek - Î•Î»Î»Î·Î½Î¹ÎºÎ¬</option>--}}
{{--                                                    <option value="gn" {{ $data['code']== 'gn'?'selected':'' }}>Guarani</option>--}}
{{--                                                    <option value="gu" {{ $data['code']== 'gu'?'selected':'' }}>Gujarati - àª—à«àªœàª°àª¾àª¤à«€</option>--}}
{{--                                                    <option value="ha" {{ $data['code']== 'ha'?'selected':'' }}>Hausa</option>--}}
{{--                                                    <option value="haw" {{ $data['code']== 'haw'?'selected':'' }}>Hawaiian - Ê»ÅŒlelo HawaiÊ»i</option>--}}
{{--                                                    <option value="he" {{ $data['code']== 'he'?'selected':'' }}>Hebrew - ×¢×‘×¨×™×ª</option>--}}
{{--                                                    <option value="hi" {{ $data['code']== 'hi'?'selected':'' }}>Hindi - à¤¹à¤¿à¤¨à¥à¤¦à¥€</option>--}}
{{--                                                    <option value="hu" {{ $data['code']== 'hu'?'selected':'' }}>Hungarian - magyar</option>--}}
{{--                                                    <option value="is" {{ $data['code']== 'is'?'selected':'' }}>Icelandic - Ã­slenska</option>--}}
...
{{--                                                    <option value="ja" {{ $data['code']== 'ja'?'selected':'' }}>Japanese - æ—¥æœ¬èªž</option>--}}
{{--                                                    <option value="kn" {{ $data['code']== 'kn'?'selected':'' }}>Kannada - à²•à²¨à³à²¨à²¡</option>--}}
{{--                                                    <option value="kk" {{ $data['code']== 'kk'?'selected':'' }}>Kazakh - Ò›Ð°Ð·Ð°Ò› Ñ‚Ñ–Ð»Ñ–</option>--}}
{{--                                                    <option value="km" {{ $data['code']== 'km'?'selected':'' }}>Khmer - ážáŸ’áž˜áŸ‚ážš</option>--}}
{{--                                                    <option value="ko" {{ $data['code']== 'ko'?'selected':'' }}>Korean - í•œêµ­ì–´</option>--}}
{{--                                                    <option value="ku" {{ $data['code']== 'ku'?'selected':'' }}>Kurdish - KurdÃ®</option>--}}
{{--                                                    <option value="ky" {{ $data['code']== 'ky'?'selected':'' }}>Kyrgyz - ÐºÑ‹Ñ€Ð³Ñ‹Ð·Ñ‡Ð°</option>--}}
{{--                                                    <option value="lo" {{ $data['code']== 'lo'?'selected':'' }}>Lao - àº¥àº²àº§</option>--}}
{{--                                                    <option value="la" {{ $data['code']== 'la'?'selected':'' }}>Latin</option>--}}
{{--                                                    <option value="lv" {{ $data['code']== 'lv'?'selected':'' }}>Latvian - latvieÅ¡u</option>--}}
{{--                                                    <option value="ln" {{ $data['code']== 'ln'?'selected':'' }}>Lingala - lingÃ¡la</option>--}}
{{--                                                    <option value="lt" {{ $data['code']== 'lt'?'selected':'' }}>Lithuanian - lietuviÅ³</option>--}}
{{--                                                    <option value="mk" {{ $data['code']== 'mk'?'selected':'' }}>Macedonian - Ð¼Ð°ÐºÐµÐ´Ð¾Ð½ÑÐºÐ¸</option>--}}
{{--                                                    <option value="ms" {{ $data['code']== 'ms'?'selected':'' }}>Malay - Bahasa Melayu</option>--}}
{{--                                                    <option value="ml" {{ $data['code']== 'ml'?'selected':'' }}>Malayalam - à´®à´²à´¯à´¾à´³à´‚</option>--}}
{{--                                                    <option value="mt" {{ $data['code']== 'mt'?'selected':'' }}>Maltese - Malti</option>--}}
{{--                                                    <option value="mr" {{ $data['code']== 'mr'?'selected':'' }}>Marathi - à¤®à¤°à¤¾à¤ à¥€</option>--}}
{{--                                                    <option value="mn" {{ $data['code']== 'mn'?'selected':'' }}>Mongolian - Ð¼Ð¾Ð½Ð³Ð¾Ð»</option>--}}
{{--                                                    <option value="ne" {{ $data['code']== 'ne'?'selected':'' }}>Nepali - à¤¨à¥‡à¤ªà¤¾à¤²à¥€</option>--}}
{{--                                                    <option value="no" {{ $data['code']== 'no'?'selected':'' }}>Norwegian - norsk</option>--}}
{{--                                                    <option value="nb" {{ $data['code']== 'nb'?'selected':'' }}>Norwegian BokmÃ¥l - norsk bokmÃ¥l</option>--}}
...
{{--                                                    <option value="or" {{ $data['code']== 'or'?'selected':'' }}>Oriya - à¬“à¬¡à¬¼à¬¿à¬†</option>--}}
{{--                                                    <option value="om" {{ $data['code']== 'om'?'selected':'' }}>Oromo - Oromoo</option>--}}
{{--                                                    <option value="ps" {{ $data['code']== 'ps'?'selected':'' }}>Pashto - Ù¾ÚšØªÙˆ</option>--}}
{{--                                                    <option value="fa" {{ $data['code']== 'fa'?'selected':'' }}>Persian - ÙØ§Ø±Ø³ÛŒ</option>--}}
{{--                                                    <option value="pl" {{ $data['code']== 'pl'?'selected':'' }}>Polish - polski</option>--}}
{{--                                                    <option value="pt" {{ $data['code']== 'pt'?'selected':'' }}>Portuguese - portuguÃªs</option>--}}
{{--                                                    <option value="pt-BR" {{ $data['code']== 'pt-BR'?'selected':'' }}>Portuguese (Brazil) - portuguÃªs (Brasil)</option>--}}
{{--                                                    <option value="pt-PT" {{ $data['code']== 'pt-PT'?'selected':'' }}>Portuguese (Portugal) - portuguÃªs (Portugal)</option>--}}
{{--                                                    <option value="pa" {{ $data['code']== 'pa'?'selected':'' }}>Punjabi - à¨ªà©°à¨œà¨¾à¨¬à©€</option>--}}
{{--                                                    <option value="qu" {{ $data['code']== 'qu'?'selected':'' }}>Quechua</option>--}}
{{--                                                    <option value="ro" {{ $data['code']== 'ro'?'selected':'' }}>Romanian - romÃ¢nÄƒ</option>--}}
{{--                                                    <option value="mo" {{ $data['code']== 'mo'?'selected':'' }}>Romanian (Moldova) - romÃ¢nÄƒ (Moldova)</option>--}}
{{--                                                    <option value="rm" {{ $data['code']== 'rm'?'selected':'' }}>Romansh - rumantsch</option>--}}
{{--                                                    <option value="ru" {{ $data['code']== 'ru'?'selected':'' }}>Russian - Ñ€ÑƒÑÑÐºÐ¸Ð¹</option>--}}
{{--                                                    <option value="gd" {{ $data['code']== 'gd'?'selected':'' }}>Scottish Gaelic</option>--}}
{{--                                                    <option value="sr" {{ $data['code']== 'sr'?'selected':'' }}>Serbian - ÑÑ€Ð¿ÑÐºÐ¸</option>--}}
...
{{--                                                    <option value="si" {{ $data['code']== 'si'?'selected':'' }}>Sinhala - à·ƒà·’à¶‚à·„à¶½</option>--}}
{{--                                                    <option value="sk" {{ $data['code']== 'sk'?'selected':'' }}>Slovak - slovenÄina</option>--}}
{{--                                                    <option value="sl" {{ $data['code']== 'sl'?'selected':'' }}>Slovenian - slovenÅ¡Äina</option>--}}
{{--                                                    <option value="so" {{ $data['code']== 'so'?'selected':'' }}>Somali - Soomaali</option>--}}
{{--                                                    <option value="st" {{ $data['code']== 'st'?'selected':'' }}>Southern Sotho</option>--}}
{{--                                                    <option value="es" {{ $data['code']== 'es'?'selected':'' }}>Spanish - espaÃ±ol</option>--}}
{{--                                                    <option value="es-AR" {{ $data['code']== 'es-AR'?'selected':'' }}>Spanish (Argentina) - espaÃ±ol (Argentina)</option>--}}
{{--                                                    <option value="es-419" {{ $data['code']== 'es-419'?'selected':'' }}>Spanish (Latin America) - espaÃ±ol (LatinoamÃ©rica)--}}
{{--                                                    </option>--}}
{{--                                                    <option value="es-MX" {{ $data['code']== 'es-MX'?'selected':'' }}>Spanish (Mexico) - espaÃ±ol (MÃ©xico)</option>--}}
{{--                                                    <option value="es-ES" {{ $data['code']== 'es-ES'?'selected':'' }}>Spanish (Spain) - espaÃ±ol (EspaÃ±a)</option>--}}
{{--                                                    <option value="es-US" {{ $data['code']== 'es-US'?'selected':'' }}>Spanish (United States) - espaÃ±ol (Estados Unidos)--}}
{{--                                                    </option>--}}
...
{{--                                                    <option value="tg" {{ $data['code']== 'tg'?'selected':'' }}>Tajik - Ñ‚Ð¾Ò·Ð¸ÐºÓ£</option>--}}
{{--                                                    <option value="ta" {{ $data['code']== 'ta'?'selected':'' }}>Tamil - à®¤à®®à®¿à®´à¯</option>--}}
{{--                                                    <option value="tt" {{ $data['code']== 'tt'?'selected':'' }}>Tatar</option>--}}
{{--                                                    <option value="te" {{ $data['code']== 'te'?'selected':'' }}>Telugu - à°¤à±†à°²à±à°—à±</option>--}}
{{--                                                    <option value="th" {{ $data['code']== 'th'?'selected':'' }}>Thai - à¹„à¸—à¸¢</option>--}}
{{--                                                    <option value="ti" {{ $data['code']== 'ti'?'selected':'' }}>Tigrinya - á‰µáŒáˆ­áŠ›</option>--}}
{{--                                                    <option value="to" {{ $data['code']== 'to'?'selected':'' }}>Tongan - lea fakatonga</option>--}}
{{--                                                    <option value="tr" {{ $data['code']== 'tr'?'selected':'' }}>Turkish - TÃ¼rkÃ§e</option>--}}
{{--                                                    <option value="tk" {{ $data['code']== 'tk'?'selected':'' }}>Turkmen</option>--}}
{{--                                                    <option value="tw" {{ $data['code']== 'tw'?'selected':'' }}>Twi</option>--}}
{{--                                                    <option value="uk" {{ $data['code']== 'uk'?'selected':'' }}>Ukrainian - ÑƒÐºÑ€Ð°Ñ—Ð½ÑÑŒÐºÐ°</option>--}}
{{--                                                    <option value="ur" {{ $data['code']== 'ur'?'selected':'' }}>Urdu - Ø§Ø±Ø¯Ùˆ</option>--}}
{{--                                                    <option value="ug" {{ $data['code']== 'ug'?'selected':'' }}>Uyghur</option>--}}
{{--                                                    <option value="uz" {{ $data['code']== 'uz'?'selected':'' }}>Uzbek - oâ€˜zbek</option>--}}
{{--                                                    <option value="vi" {{ $data['code']== 'vi'?'selected':'' }}>Vietnamese - Tiáº¿ng Viá»‡t</option>--}}
...
{{--                                                    <option value="yo" {{ $data['code']== 'yo'?'selected':'' }}>Yoruba - ÃˆdÃ¨ YorÃ¹bÃ¡</option>--}}
