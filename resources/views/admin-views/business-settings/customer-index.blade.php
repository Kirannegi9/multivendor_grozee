                                        ...
                                        <div class="form-group mb-0">
                                            <label
                                                ...
                                                <input type="checkbox" data-id="customer_verification_status"
                                                    ...
                                                    data-text-off="<p>{{ translate('messages.If_you_disable_this,_Customers_donâ€™t_need_to_verify_their_account_via_OTP.') }}</p>"
                                        ...
                                        <div class="form-group mb-0">
                                            <label
                                                ...
                                                <span
                                                    ...
                                                    <span class="input-label-secondary" data-toggle="tooltip"
                                                        data-placement="right"
                                                        data-original-title="{{ translate('messages.With_this_feature,_customers_can_have_virtual_wallets_in_their_account_via_Customer_App_&_Website._They_can_also_earn_(via_referral,_refund,_loyalty_points,_or_cashback)_and_buy_with_the_walletâ€™s_amount.') }}">
                                                        <img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                            alt="{{ translate('messages.show_hide_food_menu') }}">
                                                    </span>
                                                </span>
                                        ...
                                        <div class="form-group mb-0">
                                            <label
                                                ...
                                                <span class="pr-2">{{ translate('messages.refund_to_wallet') }}<span
                                                        ...
                                                        data-placement="right"
                                                        data-original-title="{{ translate('messages.If_itâ€™s_enabled,_Customers_will_automatically_receive_the_refunded_amount_in_their_wallets._But_if_itâ€™s_disabled,_the_Admin_will_handle_the_Refund_Request_in_his_convenient_transaction_channel.') }}"><img
                                                            src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                    ...
                                                    <div class="form-group mb-0">
                                                        <label
                                                            ...
                                                            type="checkbox" data-id="new_customer_discount_status"
                                                                ...
                                                                data-text-off="<p>{{ translate('mo.If_you_disable_this,_Customers_wonâ€™t_get_any_discount_on_first_order.') }}</p>"
                                                                class="status toggle-switch-input dynamic-checkbox-toggle "
