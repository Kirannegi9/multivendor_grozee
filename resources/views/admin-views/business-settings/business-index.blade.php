    ...
    <div class="content container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="mt-2">
                    {{ translate('messages.By_turning_the_â€˜Maintenance_Modeâ€™_ON,_all_your_apps_and_customer_website_will_be_disabled_temporarily._Only_the_Admin_Panel,_Admin_Landing_Page_&_Store_Panel_will_be_functional.') }}
                </div>
            </div>
        </div>
                                ...
                                <div class="col-md-4 col-xl-5">
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="form-label"
                                            ...
                                            <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('messages.make_visitors_aware_of_your_businessâ€˜s_rights_&_legal_information.') }}">
                                                <img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="">
                                            </span>
                                        </label>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-3 align-items-end">
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="form-label text-capitalize"
                                            ...
                                            <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('messages.Set_up_â€˜Default_Commission_Rateâ€™_on_every_Order._Admin_can_also_set_store-wise_different_commission_rates_from_respective_store_settings.') }}">
                                                <img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="">
                                            </span>
                                        </label>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        {{translate('messages.Commission_Rate_On_Delivery_Charge')}} (%)
                                            <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('messages.Set_a_default_â€˜Commission_Rateâ€™_for_freelance_deliverymen_(under_admin)_on_every_deliveryman. ') }}">
                                                <img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="">
                                            </span>
                                        </label>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('messages.If_enabled,_the_customer_will_see_the_total_product_price,_including_VAT/Tax._If_itâ€™s_disabled,_the_VAT/Tax_will_be_added_separately_with_the_total_cost_of_the_product.')}}">
                                            <img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="">
                                        </span>
                                        </span>
                                            <input type="checkbox"
                                                   ...
                                                   data-title-on="{{ translate('messages.Want_to') }} <strong>{{ translate('messages.â€˜Include_Tax_Amount?â€™') }}</strong>"
                                                   data-title-off="{{ translate('messages.Want_to_disable') }} <strong>{{ translate('messages.Tax_Amountâ€™?') }}</strong>"
                                        ...
                                        <label
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                <span class="line--limit-1">
                                                    {{ translate('messages.Customerâ€™s_Food_Preference') }}
                                                </span>
                                            ...
                                            <input type="checkbox"
                                                   ...
                                                   data-title-on="{{ translate('messages.Want_to_enable_the') }} <strong>{{ translate('messages.â€˜Veg/Non-Vegâ€™_feature?') }}</strong>"
                                        ...
                                        <label class="form-label d-flex justify-content-between text-capitalize mb-1"
                                            ...
                                            <span class="line--limit-1">{{ translate('messages.free_delivery_over') }}
                                                ...
                                                class="text-danger"><span class="form-label-secondary"
                                                    data-toggle="tooltip" data-placement="right"
                                                    data-original-title="{{ translate('messages.Set_a_minimum_order_value_for_automated_free_delivery._If_the_minimum_amount_is_exceeded,_the_Delivery_Fee_is_deducted_from_Adminâ€™s_commission_and_added_to_Adminâ€™s_expense.') }}"><img
                                                        src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                            ...
                                            <div class="form-group mb-0">
                                                <label class="form-label d-flex justify-content-between text-capitalize mb-1"
                                                    ...
                                                    <span class="line--limit-1">{{ translate('messages.additional_charge_name') }}
                                                        ...
                                                        class="text-danger"><span class="form-label-secondary"
                                                            data-toggle="tooltip" data-placement="right"
                                                            data-original-title="{{ translate('messages.Set_a_name_for_the_additional_charge,_e.g._â€œProcessing_Feeâ€.') }}"><img
                                                                src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                                alt="{{ translate('messages.free_over_delivery_message') }}"></span>
                                                        *</small></span>
                                                </label>
                            ...
                            <div class="__bg-F8F9FC-card p-0 mt-4">
                                <div class="border-bottom p-3">
                                    <h4 class="card-title m-0 text--title">{{translate('Surge Charge')}}</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3 align-items-end">
                                        <div class="col-sm-6 col-lg-4">
                                            @php($surge_charge_status = \App\Models\BusinessSetting::where('key', 'surge_charge_status')->first())
                                            @php($surge_charge_status = $surge_charge_status ? $surge_charge_status->value : 0)
                                            <div class="form-group mb-0">
                                                <label
                                                    class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control">
                                                    <span class="pr-1 d-flex align-items-center switch--label">
                                                        <span class="line--limit-1">
                                                            {{translate('messages.surge_charge') }}
                                                        </span>
                                                        <span class="form-label-secondary text-danger d-flex"
                                                            data-toggle="tooltip" data-placement="right"
                                                            data-original-title="{{ translate('messages.If_enabled,_customers_need_to_pay_an_extra_charge_while_checking_out_orders.')}}"><img
                                                    ...
                                                    <input type="checkbox"
                                                        data-id="surge_charge_status"
                                                        data-type="toggle"
                                                        data-image-on="{{ asset('/public/assets/admin/img/modal/dm-tips-on.png') }}"
                                                        data-image-off="{{ asset('/public/assets/admin/img/modal/dm-tips-off.png') }}"
                                                        data-title-on="<strong>{{ translate('messages.Want_to_enable_surge_charge?') }}</strong>"
                                                        data-title-off="<strong>{{ translate('messages.Want_to_disable_surge_charge?') }}</strong>"
                                                        data-text-on="<p>{{ translate('messages.If_you_enable_this,_surge_charge_will_be_added_with_order_amount,_it_will_be_added_in_admin_wallet') }}</p>"
                                                        data-text-off="<p>{{ translate('messages.If_you_disable_this,_surge_charge_will_not_be_added_with_order_amount.') }}</p>"
                                                        class="status toggle-switch-input dynamic-checkbox-toggle"
                                                        value="1"
                                                        name="surge_charge_status" id="surge_charge_status"
                                                        {{ $surge_charge_status == 1 ? 'checked' : '' }}>
                                                    <span class="toggle-switch-label text">
                                                        <span class="toggle-switch-indicator"></span>
                                                    </span>
                                                </label>
                                        ...
                                        <!-- <div class="col-sm-6 col-lg-4">
                                            @php($surge_charge_name = \App\Models\BusinessSetting::where('key', 'surge_charge_name')->first())
                                            <div class="form-group mb-0">
                                                <label class="form-label d-flex justify-content-between text-capitalize mb-1"
                                                    for="surge_charge_name">
                                                    <span class="line--limit-1">{{ translate('messages.surge_charge_name') }}
                                                        <small
                                                        class="text-danger"><span class="form-label-secondary"
                                                            data-toggle="tooltip" data-placement="right"
                                                            data-original-title="{{ translate('messages.Set_a_name_for_the_surge_charge,_e.g._â€œProcessing_Feeâ€.') }}"><img
                                                                src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                                alt="{{ translate('messages.free_over_delivery_message') }}"></span>
                                                        *</small></span>
                                                </label>

                                                <input type="text" name="surge_charge_name" class="form-control"
                                                    id="surge_charge_name"  placeholder="{{ translate('messages.Ex:_Processing_Fee') }}"
                                                    value="{{ $surge_charge_name ? $surge_charge_name->value : '' }}" {{ isset($surge_charge_status) ? '' : 'readonly' }} required>
                                            </div>
                                        </div> -->
                                        <div class="col-sm-6 col-lg-4">
                                            @php($surge_charge = \App\Models\BusinessSetting::where('key', 'surge_charge')->first())
                                            <div class="form-group mb-0">
                                                <label class="form-label d-flex justify-content-between text-capitalize mb-1"
                                                    for="surge_charge">
                                                    <span class="line--limit-1">{{ translate('messages.charge_amount') }}
                                                        ...
                                                        class="text-danger"><span class="form-label-secondary"
                                                            data-toggle="tooltip" data-placement="right"
                                                            data-original-title="{{ translate('messages.Set_the_value_(amount)_customers_need_to_pay_as_surge_charge.') }}"><img
                                                                src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                                alt="{{ translate('messages.free_over_delivery_message') }}"></span>
                                                        *</small></span>
                                                </label>

                                                <input type="number" name="surge_charge" class="form-control"
                                                    id="surge_charge"  placeholder="{{ translate('messages.Ex:_10') }}"
                                                    value="{{ $surge_charge ? $surge_charge->value : 0 }}"
                                                    min="0" step=".01" {{ isset($surge_charge_status) ? '' : 'readonly' }}>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="__bg-F8F9FC-card p-0 mt-4">
                                <div class="border-bottom p-3">
                                    <h4 class="card-title m-0 text--title">{{translate('Processing Charge')}}</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3 align-items-end">
                                        <div class="col-sm-6 col-lg-4">
                                            @php($processing_charge_status = \App\Models\BusinessSetting::where('key', 'processing_charge_status')->first())
                                            @php($processing_charge_status = $processing_charge_status ? $processing_charge_status->value : 0)
                                            <div class="form-group mb-0">
                                                <label
                                                    class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control">
                                                    <span class="pr-1 d-flex align-items-center switch--label">
                                                        <span class="line--limit-1">
                                                            {{translate('messages.processing_charge') }}
                                                        </span>
                                                        <span class="form-label-secondary text-danger d-flex"
                                                            data-toggle="tooltip" data-placement="right"
                                                            data-original-title="{{ translate('messages.If_enabled,_customers_need_to_pay_an_extra_charge_while_checking_out_orders.')}}"><img
                                                    ...
                                                    <input type="checkbox"
                                                        data-id="processing_charge_status"
                                                        data-type="toggle"
                                                        data-image-on="{{ asset('/public/assets/admin/img/modal/dm-tips-on.png') }}"
                                                        data-image-off="{{ asset('/public/assets/admin/img/modal/dm-tips-off.png') }}"
                                                        data-title-on="<strong>{{ translate('messages.Want_to_enable_processing_charge?') }}</strong>"
                                                        data-title-off="<strong>{{ translate('messages.Want_to_disable_processing_charge?') }}</strong>"
                                                        data-text-on="<p>{{ translate('messages.If_you_enable_this,_processing_charge_will_be_added_with_order_amount,_it_will_be_added_in_admin_wallet') }}</p>"
                                                        data-text-off="<p>{{ translate('messages.If_you_disable_this,_processing_charge_will_not_be_added_with_order_amount.') }}</p>"
                                                        class="status toggle-switch-input dynamic-checkbox-toggle"
                                                        value="1"
                                                        name="processing_charge_status" id="processing_charge_status"
                                                        {{ $processing_charge_status == 1 ? 'checked' : '' }}>
                                                    <span class="toggle-switch-label text">
                                                        <span class="toggle-switch-indicator"></span>
                                                    </span>
                                                </label>
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            @php($processing_charge = \App\Models\BusinessSetting::where('key', 'processing_charge')->first())
                                            <div class="form-group mb-0">
                                                <label class="form-label d-flex justify-content-between text-capitalize mb-1"
                                                    for="surge_charge">
                                                    <span class="line--limit-1">{{ translate('messages.charge_amount') }}
                                                        ...
                                                        class="text-danger"><span class="form-label-secondary"
                                                            data-toggle="tooltip" data-placement="right"
                                                            data-original-title="{{ translate('messages.Set_the_value_(amount)_customers_need_to_pay_as_processing_charge.') }}"><img
                                                                src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                                alt="{{ translate('messages.free_over_delivery_message') }}"></span>
                                                        *</small></span>
                                                </label>
                                                ...
                                                <input type="number" name="processing_charge" class="form-control"
                                                    id="processing_charge"  placeholder="{{ translate('messages.Ex:_10') }}"
                                                    value="{{ $processing_charge ? $processing_charge->value : 0 }}"
                                                    min="0" step=".01" {{ isset($processing_charge_status) ? '' : 'readonly' }}>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="__bg-F8F9FC-card p-0 mt-4">
                                <div class="border-bottom p-3">
                                    <h4 class="card-title m-0 text--title">{{translate('Small Cart Charge')}}</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3 align-items-end">
                                        <div class="col-sm-6 col-lg-4">
                                            @php($smallcart_charge_status = \App\Models\BusinessSetting::where('key', 'smallcart_charge_status')->first())
                                            @php($smallcart_charge_status = $smallcart_charge_status ? $smallcart_charge_status->value : 0)
                                            <div class="form-group mb-0">
                                                <label
                                                    class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control">
                                                    <span class="pr-1 d-flex align-items-center switch--label">
                                                        <span class="line--limit-1">
                                                            {{translate('messages.smallcart_charge') }}
                                                        </span>
                                                        <span class="form-label-secondary text-danger d-flex"
                                                            data-toggle="tooltip" data-placement="right"
                                                            data-original-title="{{ translate('messages.If_enabled,_customers_need_to_pay_an_extra_charge_while_checking_out_orders.')}}"><img
                                                    ...
                                                    <input type="checkbox"
                                                        data-id="smallcart_charge_status"
                                                        data-type="toggle"
                                                        data-image-on="{{ asset('/public/assets/admin/img/modal/dm-tips-on.png') }}"
                                                        data-image-off="{{ asset('/public/assets/admin/img/modal/dm-tips-off.png') }}"
                                                        data-title-on="<strong>{{ translate('messages.Want_to_enable_smallcart_charge?') }}</strong>"
                                                        data-title-off="<strong>{{ translate('messages.Want_to_disable_smallcart_charge?') }}</strong>"
                                                        data-text-on="<p>{{ translate('messages.If_you_enable_this,_smallcart_charge_will_be_added_with_order_amount,_it_will_be_added_in_admin_wallet') }}</p>"
                                                        data-text-off="<p>{{ translate('messages.If_you_disable_this,_smallcart_charge_will_not_be_added_with_order_amount.') }}</p>"
                                                        class="status toggle-switch-input dynamic-checkbox-toggle"
                                                        value="1"
                                                        name="smallcart_charge_status" id="smallcart_charge_status"
                                                        {{ $smallcart_charge_status == 1 ? 'checked' : '' }}>
                                                    <span class="toggle-switch-label text">
                                                        <span class="toggle-switch-indicator"></span>
                                                    </span>
                                                </label>
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            @php($smallcart_value = \App\Models\BusinessSetting::where('key', 'smallcart_value')->first())
                                            <div class="form-group mb-0">
                                                <label class="form-label d-flex justify-content-between text-capitalize mb-1"
                                                    for="smallcart_value">
                                                    <span class="line--limit-1">{{ translate('messages.minimum_cart_value') }}
                                                        <small
                                                        class="text-danger"><span class="form-label-secondary"
                                                            data-toggle="tooltip" data-placement="right"
                                                            data-original-title="{{ translate('messages.Set_minimum_cart_value,_e.g._â€œ100â€.') }}"><img
                                                                src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                                alt="{{ translate('messages.free_over_delivery_message') }}"></span>
                                                        *</small></span>
                                                </label>

                                                <input type="text" name="smallcart_value" class="form-control"
                                                    id="smallcart_value"  placeholder="{{ translate('messages.Ex:100') }}"
                                                    value="{{ $smallcart_value ? $smallcart_value->value : '' }}" {{ isset($smallcart_charge_status) ? '' : 'readonly' }} required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-lg-4">
                                            @php($smallcart_charge = \App\Models\BusinessSetting::where('key', 'smallcart_charge')->first())
                                            <div class="form-group mb-0">
                                                <label class="form-label d-flex justify-content-between text-capitalize mb-1"
                                                    for="smallcart_charge">
                                                    <span class="line--limit-1">{{ translate('messages.charge_amount') }}
                                                        ({{ \App\CentralLogics\Helpers::currency_symbol() }}) <small
                                                        class="text-danger"><span class="form-label-secondary"
                                                            data-toggle="tooltip" data-placement="right"
                                                            data-original-title="{{ translate('messages.Set_the_value_(amount)_customers_need_to_pay_as_smallcart_charge.') }}"><img
                                                                src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                                alt="{{ translate('messages.free_over_delivery_message') }}"></span>
                                                        *</small></span>
                                                </label>

                                                <input type="number" name="smallcart_charge" class="form-control"
                                                    id="smallcart_charge"  placeholder="{{ translate('messages.Ex:_10') }}"
                                                    value="{{ $smallcart_charge ? $smallcart_charge->value : 0 }}"
                                                    min="0" step=".01" {{ isset($smallcart_charge_status) ? '' : 'readonly' }}>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="form-group mb-0">
                                                <label
                                                    ...
                                                    data-text-off="<p>{{ translate('If_disabled,_the_subscription_based_store_business_model_option_will_be_hidden_from_this_store_panel._The_existing_subscribed_storesâ€™_subscriptions_will_be_valid_till_the_packages_expire') }}</p>"
                                                    class="status toggle-switch-input dynamic-checkbox-toggle"
                                                        value="1"
    ...
    <script>
        ...
        $(document).on('click', '.maintenance-mode', function () {
            ...
            Swal.fire({
                ...
                text: '{{ translate('messages.all_your_apps_and_customer_website_will_be_disabled_until_you_â€˜Turn_Offâ€™ _maintenance_mode.') }}',
                type: 'warning',
