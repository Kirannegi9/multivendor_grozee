...
<div class="card">
    <div class="card-body">
        <div class="text-center max-w-700 mx-auto pt-5">
            ...
            <p class="mb-4">{{ translate('Uh oh! You didnâ€™t created any advertisement yet') }}!</p>
            <div class="pb-4">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pt-0">
                <div class="text-center max-w-700 mx-auto">
                    ...
                    <p class="mb-4 fs-12 mx-auto max-w-520">{{ translate('Congratulations on creating your ad! Itâ€™s now awaiting approval. To finalize the process & make payment arrangements, please contact our')}} <a class="text--underline" href="mailto:{{\App\CentralLogics\Helpers::get_settings('email_address')  }}">{{ translate('Admin directly.') }}</a>
