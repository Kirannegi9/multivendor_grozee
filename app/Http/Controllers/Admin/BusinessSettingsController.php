...
class BusinessSettingsController extends Controller
{
    ...
    public function business_setup(Request $request)
    {
        ...
        DB::table('business_settings')->updateOrInsert(['key' => 'additional_charge'], [
         ...
         DB::table('business_settings')->updateOrInsert(['key' => 'surge_charge_status'], [
            'value' => $request['surge_charge_status'] ? $request['surge_charge_status'] : null
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'surge_charge'], [
            'value' => $request['surge_charge'] ? $request['surge_charge'] : null
        ]);
        
        DB::table('business_settings')->updateOrInsert(['key' => 'processing_charge_status'], [
            'value' => $request['processing_charge_status'] ? $request['processing_charge_status'] : null
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'processing_charge'], [
            'value' => $request['processing_charge'] ? $request['processing_charge'] : null
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'smallcart_charge_status'], [
            'value' => $request['smallcart_charge_status'] ? $request['smallcart_charge_status'] : null
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'smallcart_value'], [
            'value' => $request['smallcart_value'] ? $request['smallcart_value'] : null
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'smallcart_charge'], [
            'value' => $request['smallcart_charge'] ? $request['smallcart_charge'] : null
        ]);
