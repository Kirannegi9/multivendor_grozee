    ...
    public function add_new_address(Request $request)
    {
        ...
        if (!is_numeric($longitude) || !is_numeric($latitude)) {
            return response()->json([
                'errors' => [['code' => 'coordinates', 'message' => translate('messages.invalid_coordinates')]]
            ], 400);
        }
        ...
        $point = new Point($latitude, $longitude, 4326); 
            ...
            $zone = Zone::whereRaw("ST_CONTAINS(coordinates, ST_GeomFromText('POINT($longitude $latitude)', 4326))")
                ->get(['id']);
