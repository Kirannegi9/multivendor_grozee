...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        ...
        Route::group(['prefix' => 'head-category', 'as' => 'head-category.'], function () {
                Route::get('/head-category', [CategoryController::class, 'head_category'])->name('indexx');
                Route::post('/store', [CategoryController::class, 'head_category_store'])->name('store'); 
                
                Route::get('/edit/{id}', [CategoryController::class, 'head_category_edit'])->name('edit'); 
                Route::post('/update/{id}', [CategoryController::class, 'head_category_update'])->name('update'); 
                Route::delete('/delete/{id}', [CategoryController::class, 'head_category_delete'])->name('delete'); 
        });
