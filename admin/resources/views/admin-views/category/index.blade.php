            ...
            <div class="card-body">
                <form action="{{isset($category)?route('admin.category.update',[$category['id']]):route('admin.category.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                        <div class="form-group">
                            <label class="input-label" for="head_category">{{ translate('messages.head_category') }}</label>
                            <select name="head_category_id" id="head_category" class="form-control">
                                <option value="">{{ translate('messages.select_head_category') }}</option>
                                @foreach($headCategories as $headCategory)
                                    <option value="{{ $headCategory->id }}" 
                                        {{ isset($category) && $category->head_category_id == $headCategory->id ? 'selected' : '' }}>
                                        {{ $headCategory->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <table id="columnSearchDatatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0 w--1">{{translate('messages.parent category')}}</th>
                        ...
                        @foreach($categories as $key=>$category)
                            <tr>
                                ...
                                <td>{{ $category->headCategory->name ?? 'N/A' }}</td> <!-- Fetch head category name -->
